document.addEventListener('DOMContentLoaded', () => {
    ...
    containerOhneSlider.style.display = 'flex'; 
    containerOhneSlider.style.justifyContent = 'center'; 
    containerOhneSlider.style.alignItems = 'center'; 

    const resizeChartContainer = () => {
        if (containerOhneSlider) {
            containerOhneSlider.style.width = '100%';
            containerOhneSlider.style.height = window.innerHeight * 0.6 + 'px';
            containerOhneSlider.style.margin = '0';
            window.chart?.reflow();
        } else {
            ...
            .then(csvText => {
                ...
                Papa.parse(csvText, {
                    ...
                    complete: ({ data }) => {
                        ...
                        // Erstelle den Chart mit Highcharts
